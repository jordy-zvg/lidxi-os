...
const preset = {
  ...
  theme: {
    extend: {
      ...
      spacing: {
        ...
        'row-x': 'var(--space-row-x)',
        'row-header-y': 'var(--space-row-header-y)',
        'kpi-label': 'var(--space-kpi-label)',
        'kpi-delta': 'var(--space-kpi-delta)',
        'form-section': 'var(--space-form-section)',
        'form-row': 'var(--space-form-row)',
        'form-field': 'var(--space-form-field)',
      },
      height: {
        touch: 'var(--size-touch-min)',
        'touch-d': 'var(--size-touch-desktop)',
        'icon-btn': 'var(--size-icon-btn)',
      },
      width: {
        'icon-btn': 'var(--size-icon-btn)',
      },
  ...
  safelist: [
    ...
    {
      pattern:
        /^(p|px|py|pt|pb|pl|pr)-(0|0\.5|1|1\.5|2|2\.5|3|3\.5|4|5|6|7|8|9|10|11|12|14|16|20|24)$/,
    },
    // Margin
    {
      pattern: /^-?(m|mx|my|mt|mb|ml|mr)-(0|0\.5|1|1\.5|2|2\.5|3|3\.5|4|5|6|7|8|9|10|11|12|14|16)$/,
    },
    // Gap
    { pattern: /^gap-(x-|y-)?(0|0\.5|1|1\.5|2|2\.5|3|3\.5|4|5|6|7|8|9|10|11|12)$/ },
    // Space
    { pattern: /^space-(x|y)-(0|0\.5|1|1\.5|2|2\.5|3|3\.5|4|5|6|7|8|9|10|11|12)$/ },
    // Height
    { pattern: /^h-(6|7|8|9|10|11|12|14|16|20|24|28|32|36|40|44|48|56|64|72|80|96)$/ },
    // Min-height
    { pattern: /^min-h-(6|7|8|9|10|11|12|14|16|20|24|28|32|36|40|44|48|56|64|72|80|96)$/ },
    // Width
    { pattern: /^w-(6|7|8|9|10|11|12|14|16|20|24|28|32|36|40|44|48|56|64|72|80|96)$/ },
    // Semantic spacing tokens
    'p-card',
    'p-card-sm',
    'p-card-lg',
